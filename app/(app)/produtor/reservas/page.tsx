              ...
              <div key={r.id} className="glass rounded-2xl border border-campo-border p-4">
                ...
                {r.status !== "concluido" && r.status !== "cancelado" && (
                  <div className="mt-3 flex gap-2">
                    {r.status === "reservado" && <form action={confirmar}><button className="rounded-lg border border-blue-900/60 px-3 py-1.5 text-xs text-blue-300 transition hover:bg-blue-950/40">Confirmar</button></form>}
