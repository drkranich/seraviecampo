...
export default async function ContaPage({
  ...
  return (
    <AppShell badge="Clube Gourmet" nav={CLIENTE_NAV} userName={profile?.full_name ?? "Cliente"} title="Minha conta" subtitle="Seus dados para entregas mais rápidas.">
      ...
      <form action={updateClienteProfile} className="relative z-20 max-w-xl space-y-4 rounded-2xl border border-campo-border glass p-6">
      ...
      <div className="relative z-0 mt-6 max-w-xl">
