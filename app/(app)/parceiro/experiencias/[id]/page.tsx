...
export default async function EditarExperienciaParceiroPage({
  params,
  searchParams,
}: {
  ...
  return (
    <AppShell badge="Parceiro de Experiências" nav={PARCEIRO_NAV} title="Editar experiência" subtitle={exp.title}>
